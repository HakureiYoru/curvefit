...
from ttkbootstrap import Style  # Import the ttkbootstrap Style class
import numpy as np
from matplotlib.figure import Figure
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg
from T3 import run_gen
...
def create_app():
    app = tk.Tk()  # Create an instance of the Tk class for the root window
    app.style = Style(theme='flatly')  # Use an existing theme, such as 'flatly'
